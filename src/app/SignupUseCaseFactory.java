...
public class SignupUseCaseFactory {
    ...
    public static SignupView create(
            ClearController clearController, ViewManagerModel viewManagerModel, LoginViewModel loginViewModel, SignupViewModel signupViewModel, SignupUserDataAccessInterface userDataAccessObject) {
